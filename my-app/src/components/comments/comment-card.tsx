      ...
      <div className="w-full h-full p-3 lg:px-2 lg:py-2">
        <div className="flex items-center">
          ...
          <div className="gap-0 space-y-0 ml-2 leading-tight">
            <p className="text-[12px] md:text-[11px] font-semibold leading-none line-clamp-1">
              {meta.accountId || '匿名'}
            </p>
            <p className="text-[12px] md:text-[10px] mt-0.5 line-clamp-1">
        ...
        <div className="mt-1 lg:mt-0.5 flex-1">
          <p
            className={`text-base md:text-[11px] font-medium md:text-xs leading-snug line-clamp-3 lg:line-clamp-2 2xl:line-clamp-3`}
          >
            {text}
          </p>
        </div>

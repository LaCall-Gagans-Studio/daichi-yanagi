...
export const CANDIDATE_HIGHLIGHTS: CandidateHighlight[] = [
  {
    icon: 'award',
    text: '教員として生徒と共にMy Project Award 中国ブロック最優秀賞。政策アイデアで首相公邸へ招致。国連大使として国際舞台でスピーチ。スタンフォード大学より表彰を受け、現地での発表も行うなど、社会課題に挑む若者のモデルとして活動する卒業生を輩出。',
  },
  {
    icon: 'book',
    text: '市議会では「学校づくりからまちづくりへ」を軸に、校内フリースクールや地域連携探究、子ども食堂など、多様な学びと居場所を支える仕組みを提案。個別最適な学び・探究・STEAM教育を推進する基盤づくりを牽引。',
  },
  {
    icon: 'target',
    text: '駅前と文化施設を一体で考える「連動型まちづくり」、大学連携による地域インターン、プロ/地域スポーツ・ニュースポーツの拠点化など、都市の回遊性を高めるビジョンを提案。持続可能な財政と投資誘発の好循環をめざす。',
  },
]
